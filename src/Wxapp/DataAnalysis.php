...
class DataAnalysis extends Base
{
    ...
    public function getDailyRetain($beginDate){
        ...
        $url = 'https://api.weixin.qq.com/datacube/getweanalysisappiddailyretaininfo?access_token='.$this->token;
    ...
    public function getMonthlyRetain($beginDate){
        ...
        $url = 'https://api.weixin.qq.com/datacube/getweanalysisappidmonthlyretaininfo?access_token='.$this->token;
        $res = $this->curl_post($url,$postData);
        $res = json_decode($res,true);
    ...
    public function getWeeklyRetain($beginDate){
        ...
        $url = 'https://api.weixin.qq.com/datacube/getweanalysisappidweeklyretaininfo?access_token='.$this->token;
        $res = $this->curl_post($url,$postData);
        $res = json_decode($res,true);
    ...
    public function getDailySummary($beginDate){
        ...
        $url = 'https://api.weixin.qq.com/datacube/getweanalysisappiddailysummarytrend?access_token='.$this->token;
        $res = $this->curl_post($url,$postData);
        $res = json_decode($res,true);
    ...
    public function getDailyVisitTrend($beginDate){
        ...
        $url = 'https://api.weixin.qq.com/datacube/getweanalysisappiddailyvisittrend?access_token='.$this->token;
        $res = $this->curl_post($url,$postData);
        $res = json_decode($res,true);
    ...
    public function getMonthlyVisitTrend($beginDate){
        ...
        $url = 'https://api.weixin.qq.com/datacube/getweanalysisappidmonthlyvisittrend?access_token='.$this->token;
        $res = $this->curl_post($url,$postData);
        $res = json_decode($res,true);
    ...
    public function getWeeklyVisitTrend($beginDate){
        ...
        $url = 'https://api.weixin.qq.com/datacube/getweanalysisappidweeklyvisittrend?access_token='.$this->token;
        $res = $this->curl_post($url,$postData);
        $res = json_decode($res,true);
    ...
    public function getUserPortrait($type = 'daily'){
        ...
        $url = 'https://api.weixin.qq.com/datacube/getweanalysisappiduserportrait?access_token='.$this->token;
        $res = $this->curl_post($url,$postData);
        $res = json_decode($res,true);
    ...
    public function getVisitDistribution($beginDate){
        ...
        $url = 'https://api.weixin.qq.com/datacube/getweanalysisappidvisitdistribution?access_token='.$this->token;
        $res = $this->curl_post($url,$postData);
        $res = json_decode($res,true);
    ...
    public function getVisitPage($beginDate){
        ...
        $url = 'https://api.weixin.qq.com/datacube/getweanalysisappidvisitpage?access_token='.$this->token;
        $res = $this->curl_post($url,$postData);
        $res = json_decode($res,true);
